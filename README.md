...
- [ ] **parse_todos.py:12** - List' in line:
- [ ] **parse_todos.py:16** - section not found')
- [ ] **parse_todos.py:26** - _section = lines[start:end]
- [ ] **parse_todos.py:27** - _section))
- [ ] **update_todos.py:9** - s():
- [ ] **update_todos.py:10** - s = []
- [ ] **update_todos.py:27** - ' not in line.upper():
- [ ] **update_todos.py:29** - (case-insensitive)
- [ ] **update_todos.py:32** - ', line, maxsplit=1)
- [ ] **update_todos.py:35** - = parts[1]
- [ ] **update_todos.py:37** - = after_todo.strip()
- [ ] **update_todos.py:39** - = re.sub(r'^[:\-\s]+', '', after_todo)
- [ ] **update_todos.py:41** - .strip()
- [ ] **update_todos.py:44** - s.append((rel_path, i, desc))
- [ ] **update_todos.py:45** - s
- [ ] **update_todos.py:47** - s():
- [ ] **update_todos.py:52** - List' in line:
- [ ] **update_todos.py:77** - s):
- [ ] **update_todos.py:79** - s_sorted = sorted(todos, key=lambda x: (x[0], x[1]))
- [ ] **update_todos.py:80** - List\n']
- [ ] **update_todos.py:81** - s_sorted:
- [ ] **update_todos.py:88** - section
- [ ] **update_todos.py:89** - List'
- [ ] **update_todos.py:92** - section title', file=sys.stderr)
- [ ] **update_todos.py:117** - s from source files...')
- [ ] **update_todos.py:118** - s = collect_source_todos()
- [ ] **update_todos.py:119** - s)} TODO items.')
- [ ] **update_todos.py:120** - s)
